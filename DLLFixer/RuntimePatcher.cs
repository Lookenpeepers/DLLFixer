...
namespace DLLFixer
{
    public class RuntimePatcher
    {
        ...
        public RuntimePatcher(Mem memory, HaloDLLFixer Form)
        {
            MCCMemory = memory;
            Main = Form;
            InGameBGW.WorkerSupportsCancellation = true;
            InGameBGW.DoWork += InGameBGW_DoWork;
            InGameBGW.RunWorkerCompleted += InGameBGW_RunWorkerCompleted;
